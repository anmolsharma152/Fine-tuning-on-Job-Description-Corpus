#!/usr/bin/env python3
"""
generate_test_gemma3_12b.py
TEST — Gemma 3 12B vs Nemotron-Super 49B throughput & quality comparison.

Default model: google/gemma-3-12b-it
Default output: data/test_gemma3_12b.jsonl

Usage:
    python data/generate_test_gemma3_12b.py --count 50 --workers 10
"""
...
def main():
    parser = argparse.ArgumentParser(description="[TEST] Generate instruction data via Gemma 3 12B")
    parser.add_argument("--count", default=50, type=int, help="Records to generate")
    parser.add_argument("--output", default="data/test_gemma3_12b.jsonl", help="Output JSONL path")
    ...
    parser.add_argument("--model", default="google/gemma-3-12b-it", help="NVIDIA NIM model ID")
